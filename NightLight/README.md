...
Irrigate7 has some current sources that can be used to light LED strings. CS0..CS3 are 22mA souces. TX1 pin is used for status, and RX1 is used for Day-Night status. 
...
/1/id?
{"id":{"name":"NightLight","desc":"Irrigate7 (14320^5) Board /w atmega1284p","avr-gcc":"5.4.0"}}
```
